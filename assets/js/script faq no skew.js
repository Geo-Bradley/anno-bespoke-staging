...
ScrollReveal().reveal('.lefterval, .icon-single, .snapshot-100 .w33, .our-spirits .accordion-item', { delay: 0, origin: 'left', interval: 200});
...
const lenis = new Lenis({
  ...
  function refreshAll() {
    ...
    // Kill only specific ScrollTriggers
    ...
    gsap.to('.hero-vid', {
        ...
        scrollTrigger: {
            ...
            invalidateOnRefresh: true,
            onUpdate: () => {
                // Disable or enable skew-up triggers accordingly
                const heroVidTrigger = ScrollTrigger.getById('hero-vid-pin');
...
// Define a function for creating FAQ ScrollTriggers
...
// Call refreshAll on resize and load events
