<?php
	...
	$image_id		= esc_attr(get_post_meta($id, 'faq_hero_image_meta_field', true));
	$image_data 	= wp_get_attachment($image_id);
	$image_url 		= wp_get_attachment_url($image_id);



	$title	= esc_attr(get_post_meta($id, 'faq_hero_title_meta_field', true));
	$subheading	= esc_attr(get_post_meta($id, 'faq_hero_subheading_meta_field', true));
